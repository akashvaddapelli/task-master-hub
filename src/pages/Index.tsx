...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Nav */}
      <header className="sticky top-0 z-50 bg-card/80 glass shadow-theme-sm">
        <div className="container flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            {user ? (
              ...
              <>
                <Button variant="ghost" asChild className="press-effect hover:bg-accent rounded-full">
      ...
      <section className="container py-16 sm:py-20 md:py-28">
        <div className="mx-auto max-w-3xl text-center animate-fade-in">
          <div className="mb-5 inline-flex items-center gap-2 rounded-full border bg-card px-4 py-2 text-sm font-medium text-muted-foreground shadow-theme-sm hover-lift cursor-default">
          ...
          <p className="mt-5 max-w-xl mx-auto text-lg leading-relaxed text-muted-foreground sm:text-xl">
          ...
          <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            ...
            {!user && (
              <Button size="lg" variant="outline" asChild className="h-13 px-8 text-base hover-lift press-effect rounded-full border">
      ...
      <section className="container pb-20 sm:pb-28">
        ...
        <div className="mx-auto grid max-w-5xl gap-6 sm:gap-8 md:grid-cols-3">
          {features.map((f, i) => (
            ...
            >
              <div className="mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-primary/10 shadow-theme-xs transition-all duration-300 group-hover:bg-primary/15 group-hover:scale-110">
      ...
      <footer className="border-t bg-card/50 py-8">
        <div className="container text-center text-sm text-muted-foreground">
          {branding.name} © 2026 — {branding.tagline}
        </div>
      </footer>
    </div>
  );
